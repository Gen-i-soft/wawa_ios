...
class _SearchXMaxState extends State<SearchXMax> {
          ...
          child: SingleChildScrollView(child: Column(
            children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.end,
                children: [
                   const AutoSizeText('ผลการค้นหา ', style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30),maxLines: 1,),
                              ...
                              child: Row(
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      AutoSizeText(models[index].productname, style: const TextStyle(
  ...
  Future<void> submitBtn(BuildContext context) async {
