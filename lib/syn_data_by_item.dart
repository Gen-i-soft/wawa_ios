...
//
// class SynDatabyItem extends StatefulWidget {
//   final String? proname;
//   final String? procode;
//   SynDatabyItem({@required this.procode, @required this.proname});
//   @override
//   _SynDatabyItemState createState() => _SynDatabyItemState();
// }
//
// class _SynDatabyItemState extends State<SynDatabyItem> {
...
//
//   Future<Null> updateProductByGroup() async {
//     setState(() {
//       loading = true;
//     });
...
//         String urlAPI =
//             'http://43.229.149.11:8080/SMLJavaRESTService/v3/api/product/${widget.procode}';
//         //code = item.id from product
//
//         await Dio()
...
//       //  }
//
//       // if (_index > event.docs.length || _index == event.docs.length) {
//       //   setState(() {
//       //     loading = false;
//       //   });
//       //   print('####_index>>>$_index');
