...
// import 'package:wawa/models/unit_code_model.dart';
...
// //import 'package:wawa/utility/my_style.dart';
//
// class SynByCode extends StatefulWidget {
//   @override
//   _SynByCodeState createState() => _SynByCodeState();
// }
//
// class _SynByCodeState extends State<SynByCode> {
//   //List<GenderModel> genderModelList = [];
//   String? selectedGender;
//   List<String> categories = [];
//   List<CategoryModel> categoryModels = [];
//   List<UnitCodeModel> unitCodeModels = [];
//   double? screen;
//   int index = 0;
//   int total = 0;
//   String? txtcode;
...
//   // }
//
//   Future<Null> getDetail(String code) async {
//     setState(() {
...
//         //  .where('productId', isEqualTo: code)
//           .snapshots()
//           .listen((event) {
//         for (var item in event.docs) {
//           UnitCodeModel model = UnitCodeModel.fromMap(item.data());
//           unitCodeModels.add(model);
//         }
//       });
//       //.limit(10)
//       // .get();
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('Syn Data ที่ละรายการสินค้า'),
//       ),
//       body: Form(
//           key: _formKey,
//           child: loading
...
//                         onChanged: (value) => txtcode = value.trim(),
...
//                         itemCount: unitCodeModels.length,
//                         itemBuilder: (context, index) =>
//                           Column(children: [
//                             Text('price_0 =${unitCodeModels[index].price0}'),
//                             Text('unit_code =${unitCodeModels[index].unit_code}')
//
//                           ],),
//                         ),
//                     )
