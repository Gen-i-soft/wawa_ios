...
// class EditSaleMan extends StatefulWidget {
//   @override
//   _EditSaleManState createState() => _EditSaleManState();
// }

// class _EditSaleManState extends State<EditSaleMan> {
...
//     try {
//       QuerySnapshot qsSaleMans = await FirebaseFirestore.instance
//           .collection('wawastore')
//           .doc('wawastore')
//           .collection('saleMans')
//           .where('onoff', isEqualTo: true)
//           .orderBy('saleName', descending: false)
//           .get();

//       if(qsSaleMans.docs.length > 0){
//         print('####qsdisplayName>>>${qsSaleMans.docs.length}');
...
//         for (var item in qsSaleMans.docs) {
//           setState(() {

//             productNames.add(item['saleName']);
...
//     QuerySnapshot qsSaleName = await FirebaseFirestore.instance
//         .collection('wawastore')
//         .doc('wawastore')
//         .collection('saleMans')
//         .where('saleName', isEqualTo: v)
//         .get();
...
//     //   return;
//     // }else
//     if(qsSaleName.docs.length > 0){
//       Navigator.of(context)
//           .push(MaterialPageRoute(
//         builder: (context) =>
//             EditSaleMansDetail(document: qsSaleName.docs[0]),
//       ));
