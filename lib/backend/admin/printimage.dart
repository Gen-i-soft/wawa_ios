...
class PrintImagePage extends StatefulWidget {
  ...
  PrintImagePage({required this.document});
...
// """;
    ...
    pdf.addPage(pw.MultiPage(
        ...
        [
          ...
          //pw.Image(networkImage(purchaseModels[0].picturl)),
          //pw.Header(),
    ...
    return ListView.builder(
      ...
      itemCount: purchaseModels.length,
        ...
        return Container();
            ...
            //pw.Image(networkImage(purchaseModels[index].picturl));
          //final netImage =  networkImage(purchaseModels[index].picturl);
