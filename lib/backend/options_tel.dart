...
class OptionsTelPage extends StatefulWidget {
  final DocumentSnapshot document;
  OptionsTelPage({required this.document});
  @override
  _OptionsTelPageState createState() => _OptionsTelPageState();
}

class _OptionsTelPageState extends State<OptionsTelPage> {
  final dbRef = FirebaseFirestore.instance;
  List<String> status = [
    'รอโทรยืนยันคำสั่งซื้อ',
    'โทรยืนยันเรียบร้อยแล้ว',
  ...
  void initState() {
    ...
    super.initState();
    // checkOptions();
    selectedType = widget.document['statusCustomer'];
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'สถานะการโทรยืนยันคำสั่งซื้อของลูกค้า',
